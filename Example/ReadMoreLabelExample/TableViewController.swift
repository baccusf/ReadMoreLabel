...
class TableViewController: UIViewController {
    ...
    private let sampleData = [
        ...
        // Arabic RTL Examples  
        SampleData(
            text: "🇸🇦 هذا نص طويل باللغة العربية يوضح وظائف ReadMoreLabel في بيئة RTL. عندما تنقر على زر \"اقرأ المزيد\"، سيتوسع النص لإظهار المحتوى الكامل مع رسوم متحركة سلسة. تدعم هذه المكتبة اللغات العربية والعبرية وجميع اللغات التي تُكتب من اليمين إلى اليسار.",
            style: .basic,
            position: .end,
            language: "ar"
        ),
        SampleData(
            text: "✨ مثال عربي مع رموز تعبيرية! 🚀 يستخدم ReadMoreLabel نظام TextKit 1 لمعالجة النصوص العربية بدقة. يمكنك تخصيص النص بألوان وخطوط مختلفة. المكتبة تدعم NSAttributedString للنصوص المنسقة، مما يعطيك تحكماً كاملاً في المظهر. 📱💻🎨",
            style: .colorful,
            position: .newLine,
            language: "ar"
        ),
        SampleData(
            text: "🎨 مثال على التنسيق الملون للنص العربي! هذا يوضح كيفية عمل ReadMoreLabel مع النصوص RTL والألوان المختلفة. يمكن للمطورين استخدام خصائص النص المختلفة مثل الألوان والخطوط والأحجام. النظام يدعم التخطيط من اليمين إلى اليسار تلقائياً. 🌟✨🔥",
            style: .gradient,
            position: .end,
            language: "ar"
        ),
        SampleData(
            text: "📱 اختبار الخط العربي الكبير (24pt): هذا المثال يختبر ReadMoreLabel مع حجم خط كبير لتحسين إمكانية الوصول وسهولة القراءة. الخط الكبير يوفر وضوحاً بصرياً أفضل، ويناسب المستخدمين الذين يفضلون النصوص الكبيرة. زر \"اقرأ المزيد\" يحافظ على نفس حجم الخط الكبير للحفاظ على الاتساق البصري.",
            style: .fontSizeLarge,
            position: .newLine,
            language: "ar"
        ),
