...
class TableViewModel: ObservableObject {
    ...
    private func loadSampleData() {
        sampleData = [
            ...
            ReadMoreSampleData(
                text: "🎯 حجم الخط الكبير جداً (32pt): يُظهر هذا النص الطويل جداً وظيفة ReadMoreLabel بحجم خط كبير جداً، مثالي للعناوين الرئيسية والإعلانات المهمة جداً أو عندما تكون أقصى قابلية للقراءة مطلوبة بشكل أساسي. يوفر تجربة مستخدم متميزة ومتطورة مع دعم شامل وكامل للغة العربية الجميلة والتخطيط المتقدم من اليمين إلى اليسار بأفضل جودة ممكنة. هذا النص الإضافي يضمن ظهور زر اقرأ المزيد حتى مع الخط الكبير جداً.",
                style: .fontSizeXLarge,
                position: .end,
                language: "ar"
            ),
